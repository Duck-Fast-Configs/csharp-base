...
"1")
    ...
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Unblock && sh dfc-all.sh -d1) >&3
...
message_input "1. dfc-host-csharp\n"
...
"1")
    ...
    "1")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall && sh dfc-info.sh -d1) >&3
        ;;
    "2")
        message_space 1
    ...
    "3")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Unblock && sh dfc-incoming.sh -d1) >&3
        ;;
    "4")
        message_space 1
    ...
    "5")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Unblock && sh dfc-outcoming.sh -d1) >&3
        ;;
    "6")
        message_space 1
    ...
    "9")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Unblock && sh dfc-ip-custom.sh -d1) >&3
        ;;
    "10")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Block && sh dfc-ip-custom.sh -d1) >&3
        ;;
    "11")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Unblock && sh dfc-port-443.sh -d1) >&3
        ;;
    "12")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Firewall/Block && sh dfc-port-443.sh -d1) >&3
        ;;
    "13")
        . $dfc_project_main_folder/Scripts/Dependencies/dfc-message-exit.sh >&3
        ;;
