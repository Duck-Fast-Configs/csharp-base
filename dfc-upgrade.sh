...
setupProject() {
    ...
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-icu_libs.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-krb5_libs.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-libgcc.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-libintl.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-libssl1_1.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-libstdcpp.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-zlib.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-libgdiplus.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-csharp/Setup && sh dfc-csharp.sh -d1) >&3
